...
export const AGING_ITEMS: AgingItem[] = [
  { id: "aging-1", label: "Burberry · Trench", ageDays: 94, baseCostCents: 3800 },
  { id: "aging-2", label: "Barbour · Beaufort", ageDays: 72, baseCostCents: 3100 },
  { id: "aging-3", label: "Levi's · 501 Jeans", ageDays: 58, baseCostCents: 2400 },
  { id: "aging-4", label: "Patagonia · Retro-X", ageDays: 51, baseCostCents: 2900 },
  { id: "aging-5", label: "Carhartt WIP · Detroit", ageDays: 47, baseCostCents: 2700 },
];
